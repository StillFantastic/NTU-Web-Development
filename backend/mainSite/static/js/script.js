...
UIComponent.prototype.setEasterEggBackground = function() {
  var imageUrl = document.body.getAttribute('data-img-url');
  document.getElementsByClassName('container')[0].style.backgroundImage = 'url(' + imageUrl + ')';
...
const App = (function() {
  ...
  function checkEasterEgg(event) {
    if (event.code === 'Space') {
      ...
      // console.log(privateMembers[_spaceCount]);
